...
ARTIFACT_PATH = Path("Phase 4/artifacts/phase4_ipl_winner_best_pipeline.pkl")
...
app = FastAPI(
    title="IPL Winner Predictor - Phase 4",
    version="4.0.0",
    description="Prediction API using Phase 4 advanced feature model.",
)
