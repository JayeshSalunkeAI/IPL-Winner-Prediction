...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", default="Phase 4/results/phase4_dataset.csv")
    parser.add_argument("--results-dir", default="Phase 4/results")
    parser.add_argument("--artifacts-dir", default="Phase 4/artifacts")
...
def main() -> None:
    ...
    if not input_path.exists():
        raise FileNotFoundError(
            f"Dataset not found at {input_path}. Run 'python Phase 4/phase4_extract_dataset.py' first."
        )
